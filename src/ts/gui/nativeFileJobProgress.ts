...
export function nativeFileJobProgressText(status: NativeFileJobStatus | undefined): string {
...
export function nativeFileJobTitle(
    ...
    switch (status?.kind) {
        ...
        default:
            return kind === 'import' ? language.importRisuSave : language.exportRisuSave
    }
}
