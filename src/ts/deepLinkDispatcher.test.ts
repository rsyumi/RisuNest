...
const registration = 'risunestlocal://peer-clone/v2?endpoint=http%3A%2F%2F192.168.1.2%3A32145&session=123e4567-e89b-12d3-a456-426614174000&manifest=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa#claim=secret'
...
describe('dispatchRisuLocalUrl', () => {
    it('routes realm links without touching the device sync handler', () => {
        ...
        expect(dispatchRisuLocalUrl('risunestlocal://realm/card-1', { onRealm, onDeviceSync })).toBe(true)
