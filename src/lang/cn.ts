export const languageChinese = {
    ...
    "help": {
        ...
        "streamingDisplayOptimizationMode": "在使用正则脚本等大量后处理时，减少长回复流式生成造成的界面卡顿。对移动设备或低端设备可能有帮助。\n\n精确兼容会处理提供方的每次更新。兼容性最高，CPU 开销也最高。\n\n均衡会立即显示第一次更新，之后约每 0.125 秒只处理最新更新。有状态脚本的运行次数可能减少。\n\n强会批量显示原始预览，并仅在正常完成时进行一次语义后处理。它对中间行为的改变最大。\n\n所选模式会固定到当前生成结束。均衡或强可能改变有状态正则、Lua 或插件操作的运行次数。",
    ...
    "streamingDisplayOptimizationOff": "精确兼容",
    "streamingDisplayOptimizationBalanced": "均衡（推荐）",
    ...
    "restoreLocalSnapshot": "恢复本地快照",
    "chooseLocalSnapshot": "选择本地快照",
    "noLocalSnapshots": "没有可用的本地快照。",
    ...
    "pluginVersionWarn": "这是插件的 {{plugin_version}} 版本。它与此版本的 RisuNest 不兼容。请将插件更新到 {{required_version}} 版本。",
    ...
    "pluginRiskDetectedAlert": "RisuNest 检测到可能有害的代码，这可能会窃取您的 API 密钥或个人数据。我们建议您不要安装此插件。",
    "doNotInstall": "不要安装",
    "continueAnyway": "仍然继续",
    "pluginNoRiskButAlert": "RisuNest 没有检测到有害代码，但请注意，从不受信任的来源安装插件可能会带来安全风险。",
    ...
    screenshotTurns: "总轮数：{total}",
    screenshotInclusiveRange: "轮次范围（从 1 开始，包含起止）",
    screenshotStart: "开始",
    screenshotEnd: "结束",
    screenshotRecent50: "最近 50 轮",
    screenshotFull: "全部",
    screenshotCapture: "截取",
    screenshotProgress: "已完成 {completed}/{total} 轮",
    screenshotEmpty: "没有可截取的对话轮次。",
    screenshotIntegerRange: "请输入整数轮次。",
    screenshotRangeBounds: "轮次必须在当前对话范围内。",
