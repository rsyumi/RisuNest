export const languageEnglish = {
    ...
    peerClone: {
        title: "Device clone",
        description: "Copy this RisuNest library directly between desktop devices on the same trusted network. LAN transfer uses plain HTTP, so the bearer credential does not prevent network eavesdropping.",
