export const languageEnglish = {
    ...
    syncConflictBackupNotice: "The side you do not choose is kept as a local backup and can be restored from Settings.",
    ...
    syncConflictRestoreConfirm: "Replace the current data with this backup? The current data is saved as another backup first.",
