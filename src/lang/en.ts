export const languageEnglish = {
    ...
    risuNest: {
        ...
        sync: { menuTitle: 'Device sync', intro: 'Copy or sync your data with another device.', androidLanOnly: 'Android supports same-network (LAN) connections only.', registrationExpired: 'Registration expired. Register again with a new link.' },
    },
    peerClone: {
        title: "Device clone",
