export const languageEnglish = {
    ...
    risuNest: {
        ...
        diag: { title: 'Diagnostics', viewLog: 'View error log', copyLog: 'Copy error log', fileLog: 'Save error log to a file', fileLogHelp: 'Attach this file when reporting a problem. Secrets such as API keys are masked before being written.', logEmpty: 'No errors recorded.' },
        sync: { menuTitle: 'Device sync', intro: 'Copy or sync your data with another device.', registrationExpired: 'Registration expired. Register again with a new link.', share: { title: 'Sharing', stateOff: 'Off', statePreparing: 'Preparing', stateListening: 'Listening', stateStopping: 'Stopping', stateError: 'Error', methodLan: 'Same network (LAN)', methodQuick: 'Temporary internet address', methodFixed: 'Fixed address (advanced)', port: 'Port', publicUrl: 'Public address (URL)', quickNote: 'The address changes when you restart the app. Devices must then be registered again.', fixedNote: 'Connect the port below to your public address using your own tunnel or port forwarding. The address is saved, and registered devices reconnect without registering again.', fixedGuideTitle: 'How to connect it yourself', fixedGuideBody: 'If you use Cloudflare Tunnel: create a tunnel in the Cloudflare dashboard, install cloudflared as a service on this computer, and point the tunnel at http://127.0.0.1:{0}. The app never stores or needs the tunnel token.', autoListen: 'Start listening automatically when the app opens', start: 'Start sharing', stop: 'Stop sharing', pairTitle: 'Register a new device', pairNote: 'A registration link works for 10 minutes and for one device only.', pairRemaining: '{0} left', pairExpired: 'Expired. Create a new link.', copyLink: 'Copy link', newLink: 'Create new link', permRead: 'Allow copying data', permBidirectional: 'Allow two-way sync', permBidirectionalHelp: 'If allowed, the other device can also change data on this device.' }, devices: { title: 'Registered devices', note: 'Once registered, a device reconnects without registering again.', outgoingTitle: 'Devices that copy from this device', incomingTitle: 'Devices this device copies from', permRead: 'Copy', permBidirectional: 'Two-way', outgoingEmpty: 'None yet. Start sharing and open the registration link on another device to add it here.', incomingEmpty: "None yet. Use another device's registration link in Sync tasks below to save it here.", lastSeen: 'Last connected {0} · {1} total', revoke: 'Remove', revokeConfirm: "Remove this device? It won't be able to connect until you register it again." }, work: { title: 'Sync tasks', target: 'Target device', useNewLink: 'Use a new registration link...', linkPlaceholder: 'Paste a registration link', clone: 'Copy everything', cloneConfirm: 'This replaces all data on this device with the other device\'s data. Your current data is kept as a backup first. Continue?', delta: 'Get changes only', bidirectional: 'Two-way sync', blockedWhileSharing: 'Stop sharing to run a receive task.', progress: 'Receiving {0}%', cancel: 'Cancel', conflictTitle: 'There are conflicts', conflictBody: 'The same items changed on both devices. Choose which side to keep. The other side is kept as a backup.', conflictOthers: '{0} other items', keepThis: 'Keep this device', keepOther: 'Keep other device', resume: 'Continue', abandon: 'Abandon task', abandonConfirm: 'Cancel this sync? Nothing received so far will be applied.', doneUpToDate: 'Already up to date.', doneUpdated: 'Received {0} items ({1}).', needClone: 'A full copy is required. Use Copy everything above.', backupNote: 'Your previous data is kept as a backup.', dismiss: 'Dismiss' }, lanWarning: 'LAN connections are not encrypted. Use them only on networks you trust.', androidLanOnly: 'Android supports same-network (LAN) connections only.' },
    },
    peerClone: {
        title: "Device clone",
        description: "Copy this RisuNest library directly between devices on the same trusted network. LAN transfer uses plain HTTP, so the connection code does not prevent network eavesdropping.",
        ...
        lanMode: "Trusted LAN",
        quickTunnelMode: "Quick Tunnel (experimental)",
        quickTunnelHelp: "Quick Tunnel creates a temporary public link for this one sharing session. It is experimental and stops when sharing stops.",
        quickTunnelConfirm: "Start an experimental one-shot Quick Tunnel? The temporary public link is only for this sharing session.",
        namedTunnelMode: "Named Tunnel",
        namedTunnelToken: "Tunnel token",
        namedTunnelPublicUrl: "Expected public HTTPS base URL",
        namedTunnelHelp: "In Cloudflare, configure the published application's Service URL exactly as http://127.0.0.1:32145. The token is used only to start the native tunnel process and is never saved. Enter only the bare public HTTPS URL, for example https://sync.example.com.",
        tunnelCleanup: "Stopping the tunnel and revoking connected devices. Keep this screen open until cleanup completes.",
        ...
        revoke: "Revoke",
        target: "Replace this device from another device",
        targetHelp: "Paste the link or open the same link from a QR code. Existing local data is replaced only after confirmation.",
        pairingLink: "Pairing link",
        useLink: "Use link",
        download: "Download and replace",
        resume: "Resume",
        cancel: "Cancel",
        progress: "Progress",
    ...
    peerDelta: {
        ...
        description: "Pull only changed logical records and payloads from another desktop device. A divergent library is never replaced automatically.",
        unavailable: "Incremental update is not available on this desktop build.",
        source: "Share updates from this device",
        sourceHelp: "Prepare a fixed snapshot, then start its authenticated LAN session.",
        sourceOpenHelp: "Keep RisuNest open and sharing active on this source device until the receiving device finishes.",
        sourceStatus: "Source status",
        statusIdle: "Idle",
        statusPrepared: "Prepared",
        statusRunning: "Sharing",
        statusStopped: "Stopped",
        prepare: "Prepare update",
        start: "Start sharing",
        stop: "Stop sharing",
        pairingLink: "Incremental update link",
        copyLink: "Copy link",
        devices: "Connected devices",
        revoke: "Revoke",
        target: "Pull updates to this device",
        targetHelp: "Paste an incremental update link from a library that already shares an exact common base.",
        divergenceHelp: "Incremental update never replaces a divergent library. A first connection between mismatched devices requires the full clone above.",
        pull: "Pull updates",
        pulling: "Pulling and verifying updates...",
        noChanges: "This device is already up to date.",
        updated: (objects: number, bytes: string) => `Updated ${objects} objects (${bytes} bytes).`,
    ...
    peerBidirectional: {
        title: "Bidirectional device sync",
        description: "Exchange logical changes between paired desktop devices using their exact shared generation.",
        ...
        start: "Start pairing",
        stop: "Stop pairing",
        pairingLink: "Bidirectional sync link",
        copyLink: "Copy link",
        devices: "Paired devices",
        revoke: "Revoke",
        target: "Sync with another device",
        targetHelp: "Paste a bidirectional sync link from the other desktop device.",
        sync: "Sync both devices",
        ...
        keepRemote: "Keep the other device's version",
        backupWarning: "The losing version receives a verified lossless backup before replacement.",
        backupCreated: "Verified lossless backup created",
        backupLocal: "Backup from this device",
        backupRemote: "Backup from the other device",
        resume: "Resume sync",
        resumeRequired: "The local change is committed. Resume to finish the other device and acknowledgement.",
        sourceUnavailable: "The other device is unavailable. For a tunnel session, paste a fresh link from that device. LAN sessions may resume after the existing host returns.",
