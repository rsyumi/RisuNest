export const languageEnglish = {
    ...
    peerBidirectional: {
        ...
        sourceHelp: "Prepare and start a local session, then keep this device open until sync finishes.",
        ...
        sourceUnavailable: "The other device is unavailable. Open it and make its existing sharing session available, then resume.",
