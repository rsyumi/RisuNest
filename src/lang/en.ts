export const languageEnglish = {
    ...
    risuNest: {
        ...
        update: {
            ...
            strategies: {
                'self-install': 'In-place verified update',
        ...
        storage: {
            ...
            tempUsage: '{size} used',
            gcSeparation:
                'Clearing a broken link in the data check leaves the file behind. This is the only place a file is actually deleted.',
            gcListTitle: 'What was found',
        ...
        dataHealth: {
            title: 'Data check',
            description:
                'Checks saved characters, chats, and files for damage, and shows what is affected.',
            quickScan: 'Quick check',
            quickScanHelp:
                'Checks saved records and their links. Does not open image or media files.',
            deepScan: 'Full check',
            deepScanHelp:
                'Also reads every stored file to confirm its contents. Takes longer on large libraries.',
            cancel: 'Stop',
            resume: 'Continue',
            restart: 'Start over',
            ...
            repairTitle: 'Fix what can be fixed',
            repairHelp:
                'Choose what to do with each problem. Nothing changes until you apply it.',
            repairApply: 'Apply',
            repairApplied: 'Applied. {0} problems left.',
            repairNone: 'Nothing here can be fixed automatically.',
            repairSnapshot: 'Save a snapshot first',
            repairSnapshotHelp:
                'Keeps the current state so you can return to it even after this.',
            repairSelected: '{0} selected',
            previewTitle: 'What this will do',
            previewAnswered: 'Fixes {0} of {1} problems',
            previewReferences: 'Removes {0} links',
            previewAliases: 'Stops using {0} files',
            previewDiscards: '{0} of these drop a value that cannot be brought back',
            previewTables: 'Rewrites: {0}',
            undoTitle: 'Undo a fix',
            undoHelp:
                'Each fix can be undone while it is kept here. Files it stopped using are held until then.',
            undoAction: 'Undo',
