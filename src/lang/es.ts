export const languageSpanish = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Esto puede ser un error de CORS. Esto solo ocurre al usar la versión web debido a las limitaciones del navegador. Intenta usar la versión local de escritorio u otra versión de RisuNest.",
    ...
    "help": {
        ...
        "streamingDisplayOptimizationMode": "Reduce el lag de visualización al recibir respuestas largas por streaming con mucho posprocesamiento, como scripts basados en regex. Puede ser útil en dispositivos móviles o equipos de gama baja.\n\nCompatibilidad exacta procesa cada actualización del proveedor. Ofrece la mayor compatibilidad y el mayor coste de CPU.\n\nEquilibrado muestra la primera actualización de inmediato y después procesa solo la más reciente como máximo cada 0,125 segundos. Los scripts con estado pueden ejecutarse menos veces.\n\nFuerte muestra vistas previas sin procesar por lotes y realiza el posprocesamiento semántico una sola vez al finalizar normalmente. Es el modo que más cambia el comportamiento intermedio.\n\nEl modo elegido queda fijado hasta que termina la generación actual. Equilibrado o Fuerte puede cambiar el número de ejecuciones de acciones con estado de regex, Lua o plugins.",
        ...
        "antiClaudeOverload": "Si ocurre sobrecarga de Claude, RisuNest intentará evitarla continuando con el mismo prompt, haciéndolo menos probable que ocurra. Funciona solo para respuestas transmitidas. Esto podría no funcionar para endpoints de API no oficiales.",
    ...
    "setup": {
        ...
        "welcome": "¡Bienvenido a RisuNest! Aquí te guiaré para configurarlo. Primero, ¿cómo puedo llamarte?",
    ...
    "streamingDisplayOptimizationOff": "Compatibilidad exacta",
    "streamingDisplayOptimizationBalanced": "Equilibrado (Recomendado)",
    ...
    "officialWikiDesc": "Wiki Oficial de RisuNest. siéntete libre de consultarla.",
    "officialDiscord": "Discord Oficial",
    "officialDiscordDesc": "Discord Oficial para hablar sobre RisuNest",
    "persona": "Persona",
    "icon": "Icono",
    "account": "Cuenta",
    "remove": "Eliminar",
    ...
    "restoreLocalSnapshot": "Restaurar instantánea local",
    "chooseLocalSnapshot": "Elegir una instantánea local",
    "noLocalSnapshots": "No hay instantáneas locales disponibles.",
    ...
    "realmDesc": "RisuRealm es una plataforma de compartición de contenido para RisuNest. Puedes compartir tu personaje con otros usuarios.",
    ...
    "risupresetDesc": "El formato Risupreset es un formato específicamente diseñado para presets de RisuNest.",
    "risuMDesc": "El formato RisuM es un formato diseñado específicamente para módulos de RisuNest.",
    ...
    "pluginVersionWarn": "Esta es la versión {{plugin_version}} del plugin, que no es compatible con esta versión de RisuNest. Por favor, actualiza el plugin a la versión {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuNest detectó código que puede ser dañino y que podría ROBAR TU CLAVE API O DATOS PERSONALES. te recomendamos NO INSTALAR ESTE PLUGIN.",
    "doNotInstall": "No Instalar",
    "continueAnyway": "Continuar de Todos Modos",
    "pluginNoRiskButAlert": "RisuNest no detectó código dañino, pero ten en cuenta que instalar plugins de fuentes no confiables puede plantear riesgos de seguridad.",
    ...
    screenshotTurns: "Turnos totales: {total}",
    screenshotInclusiveRange: "Rango de turnos (desde 1, inclusivo)",
    screenshotStart: "Inicio",
    screenshotEnd: "Fin",
    screenshotRecent50: "Últimos 50",
    screenshotFull: "Todo",
    screenshotCapture: "Capturar",
    screenshotProgress: "{completed} de {total} turnos",
    screenshotEmpty: "No hay turnos para capturar.",
    screenshotIntegerRange: "Ingrese números de turno enteros.",
    screenshotRangeBounds: "Los turnos deben estar dentro de la conversación.",
