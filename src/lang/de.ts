export const languageGerman = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Dies kann ein CORS-Fehler sein. Dies geschieht nur bei Verwendung der Webversion aufgrund von Browserbeschränkungen. Versuchen Sie, die lokale Desktop-Version oder eine andere Version von RisuNest zu verwenden.",
    ...
    "help": {
        ...
        "streamingDisplayOptimizationMode": "Verringert Anzeigeruckeln, wenn lange Antworten mit viel Nachbearbeitung gestreamt werden, zum Beispiel durch regex-basierte Skripte. Das kann auf Mobilgeraeten oder leistungsschwaecherer Hardware hilfreich sein.\n\nExakte Kompatibilitaet verarbeitet jede Aktualisierung des Anbieters. Sie bietet die hoechste Kompatibilitaet und verursacht die hoechste CPU-Last.\n\nAusgewogen zeigt die erste Aktualisierung sofort und verarbeitet danach hoechstens etwa alle 0,125 Sekunden nur die neueste. Zustandsbehaftete Skripte koennen seltener ausgefuehrt werden.\n\nStark zeigt gebuendelte Rohvorschauen und fuehrt die semantische Nachbearbeitung bei normalem Abschluss genau einmal aus. Das Zwischenverhalten aendert sich am staerksten.\n\nDer gewaehlte Modus bleibt bis zum Ende der aktuellen Generierung fest. Ausgewogen oder Stark kann die Anzahl zustandsbehafteter Regex-, Lua- oder Plugin-Aktionen veraendern.",
        ...
        "antiClaudeOverload": "Wenn eine Claude-Überlastung auftritt, versucht RisuNest, diese zu verhindern, indem es mit derselben Anweisung fortfährt, wodurch die Wahrscheinlichkeit verringert wird. Funktioniert nur für gestreamte Antworten. Dies funktioniert möglicherweise nicht für inoffizielle API-Endpunkte.",
    ...
    "setup": {
        ...
        "welcome": "Willkommen bei RisuNest! Ich bin Airisu und werde Sie durch die Einrichtung von RisuNest führen. Zuerst, wie darf ich Sie nennen?",
    ...
    "streamingDisplayOptimizationOff": "Exakte Kompatibilitaet",
    "streamingDisplayOptimizationBalanced": "Ausgewogen (Empfohlen)",
    ...
    "officialWikiDesc": "Offizielles Wiki für RisuNest. Schauen Sie doch gerne bei uns vorbei",
    "officialDiscord": "Offizieller Discord",
    "officialDiscordDesc": "Offizieller Discord zum Austausch über RisuNest",
    "persona": "Mein Profil",
    "icon": "Symbol",
    "account": "Konto",
    "remove": "Entfernen",
    ...
    "restoreLocalSnapshot": "Lokalen Snapshot wiederherstellen",
    "chooseLocalSnapshot": "Lokalen Snapshot auswählen",
    "noLocalSnapshots": "Es sind keine lokalen Snapshots verfügbar.",
    ...
    "realmDesc": "RisuRealm ist eine Plattform zum Teilen von Inhalten für RisuNest. Sie können Ihren Charakter mit anderen Benutzern teilen.",
    ...
    "risupresetDesc": "Risupreset-Format ist ein Format, das speziell für RisuNest-Voreinstellungen entwickelt wurde.",
    "risuMDesc": "RisuM-Format ist ein Format, das speziell für RisuNest-Module entwickelt wurde.",
    ...
    "pluginVersionWarn": "Dies ist Version {{plugin_version}} des Plugins, die nicht mit dieser Version von RisuNest kompatibel ist. Bitte aktualisieren Sie das Plugin auf Version {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuNest hat Code erkannt, der schädlich sein könnte und IHREN API-SCHLÜSSEL ODER PERSÖNLICHE DATEN STEHLEN KANN. Wir empfehlen Ihnen, DIESES PLUGIN NICHT ZU INSTALLIEREN.",
    "doNotInstall": "Nicht installieren",
    "continueAnyway": "Trotzdem fortfahren",
    "pluginNoRiskButAlert": "RisuNest hat keinen schädlichen Code erkannt, aber beachten Sie bitte, dass die Installation von Plugins aus nicht vertrauenswürdigen Quellen Sicherheitsrisiken bergen kann.",
    ...
    screenshotTurns: "Gesamtzahl der Nachrichten: {total}",
    screenshotInclusiveRange: "Nachrichtenbereich (ab 1, einschließlich)",
    screenshotStart: "Start",
    screenshotEnd: "Ende",
    screenshotRecent50: "Letzte 50",
    screenshotFull: "Alle",
    screenshotCapture: "Aufnehmen",
    screenshotProgress: "{completed} von {total} Nachrichten",
    screenshotEmpty: "Es gibt keine Nachrichten zum Aufnehmen.",
    screenshotIntegerRange: "Geben Sie ganze Nachrichtennummern ein.",
    screenshotRangeBounds: "Die Nummern müssen innerhalb der Unterhaltung liegen.",
