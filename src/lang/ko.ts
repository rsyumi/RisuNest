export const languageKorean = {
    ...
    risuNest: {
        ...
        backup: { title: '백업·복구', officialPublish: '공식 계정 백업 만들기', officialRestore: '공식 계정 백업 복원', officialCancel: '백업 업로드 취소', officialRestoreConfirm: '공식 계정 백업으로 이 기기의 데이터를 교체할까요?', officialRestoreInlayWarning: '공식 스냅샷에는 별도로 저장된 채팅 첨부가 포함되지 않습니다. 연결된 이미지, 오디오, 동영상, 서명은 복원되지 않을 수 있습니다. 백업을 복원한 뒤 앱이 다시 시작됩니다. 계속할까요?', officialMissing: '공식 계정 백업을 찾지 못했습니다. 이 기기의 데이터는 변경되지 않았습니다.', officialPublishConfirm: '현재 이 기기의 데이터로 공식 계정 백업을 덮어쓸까요?', officialPublished: '공식 계정 백업을 만들었습니다.', actionFailed: '백업 작업을 완료하지 못했습니다. 데이터는 변경되지 않았습니다.', progressPreparing: '준비 중', progressTransferring: '데이터 전송 중', progressFinalizing: '마무리 중' },
