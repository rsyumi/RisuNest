export const languageKorean = {
    ...
    risuNest: {
        ...
        recovery: {
            ...
            exportHelp:
                '원본 데이터베이스와 파일을 변경하지 않고 저장합니다. 이 압축 파일에는 개인 데이터가 포함되며, 현재 앱에서 복원할 수 없습니다.',
            exportAction: '사본 저장',
            exportComplete: '원본 파일을 내보냈습니다.',
        ...
        storage: {
            ...
            gcStateHeld: '아직 필요함',
            gcHeldLibrary: '사용 중',
            gcHeldSnapshot: '스냅샷에서 사용 중',
            gcHeldRepair: '되돌리기에 사용 중',
        ...
        dataHealth: {
            ...
            deepScan: '정밀 검사',
            deepScanHelp:
                'DB와 저장된 파일을 모두 읽어 내용을 포함하여 이상 여부를 점검합니다.',
            cancel: '중단',
            resume: '이어서 하기',
            restart: '처음부터',
            ...
            groupMore: '이후 {0}건',
            quickScanRunning: '빠른 검사 중',
            deepScanRunning: '정밀 검사 중',
            repairRunning: '데이터를 수정하는 중',
            ...
            repairTitle: '데이터 수정',
            repairHelp: '발견된 문제를 선택적으로 수정합니다.',
            selectAll: '전체 선택',
            repairApply: '적용',
            ...
            undoTitle: '되돌리기',
            undoHelp:
                '스냅샷을 만들지 않더라도 일시적으로 변경을 되돌릴 수 있습니다. 아래 목록에서 선택하세요.',
            undoAction: '되돌리기',
            undoEntry: '{0} · 기록 {1}개 · 임시 파일 {2}개',
            undoSkipped: '고친 뒤에 바뀌어서 그대로 둔 항목: {0}',
            undoNone: '수정된 항목이 없습니다.',
            ...
            actionDiscards: '값이 삭제됨',
            actionRisky: '그 파일이 원래 가리키려던 것이라는 보장은 없습니다.',
            gcLink: '사용하지 않는 이미지로 이동',
            severityBlocking: '백업·복원을 막는 문제',
            severityBlockingHelp: '백업 및 복원에 영향을 줄 수 있는 데이터 형식에 대한 문제입니다.',
            severityDegraded: '깨져 보이는 문제',
            severityDegradedHelp: '미디어 파일의 연결을 읽을 수 없어 깨진 이미지로 보이는 문제입니다.',
            severityInformational: '정리해도 되는 항목',
            severityInformationalHelp: '어디에서도 사용하지 않아 정리해도 되는 항목입니다.',
        ...
        importDialog: {
            ...
            stagePublishingDestination: '선택한 위치에 저장하는 중',
            stageFinalizingExport: '마무리 중',
            cancelExport: '내보내기 취소',
            resultExportSucceeded: '내보내기를 완료했습니다.',
            resultExportCancelled: '내보내기를 취소했습니다.',
        ...
        onboarding: {
            ...
            external: {
                title: '외부 저장소 연결',
                lead: '서비스 연결 정보를 입력하거나 암호화된 연결 설정을 가져온 뒤, 저장소의 복구 키를 입력해주세요.',
                stepKey: '서비스와 저장소 위치를 입력하거나 연결 설정을 가져옵니다.',
