export const languageKorean = {
    ...
    risuNest: {
        ...
        storage: { title: '저장 공간', total: '전체 데이터', media: '이미지·미디어', inlays: '채팅 첨부', plugins: '플러그인 데이터', snapshots: '스냅샷', conflictBackups: '충돌 백업', counts: '캐릭터 {0}개 · 대화 {1}개 · 메시지 {2}개', createSnapshot: '스냅샷 지금 만들기', cleanSyncTemp: '동기화 임시 파일 정리', calculateSize: '크기 계산', calculateSizeFailed: '임시 파일 크기를 계산하지 못했습니다. 정보를 새로 고친 뒤 다시 시도하세요.', tempUsage: '{size} 사용 중', gcRun: '사용하지 않는 이미지 정리', gcResult: '삭제 가능: {0}개 ({1})', gcDeletedResult: '삭제됨: {0}개 ({1})', gcConfirm: '어디에서도 사용하지 않는 이미지 {0}개({1})를 삭제합니다. 계속할까요?', deleteSnapshotConfirm: '이 스냅샷을 삭제할까요? 삭제하면 이 시점으로 되돌릴 수 없습니다.', deleteConflictBackupConfirm: '이 충돌 백업을 삭제할까요? 삭제한 충돌 백업은 복구할 수 없습니다.', syncBackups: '동기화 백업', deleteSyncBackupConfirm: '이 동기화 백업을 삭제할까요? 해당 작업 이전 상태로 되돌릴 수 없게 됩니다.', syncBackupInUse: '진행 중인 동기화가 사용하는 백업이라 삭제할 수 없습니다.', cleanSyncTempNote: '남은 임시 파일만 정리합니다. 백업과 진행 중인 작업은 건드리지 않습니다.', trashedCount: '(휴지통 {0}개)', loadFailed: '저장 공간 정보를 불러오지 못했습니다.', staleTotals: '저장 공간 합계가 최신 정보가 아닐 수 있습니다. 정보를 새로 고친 뒤 다시 시도하세요.', retry: '다시 시도', actionFailed: '작업을 완료하지 못했습니다. 일부 변경이 이미 적용되었을 수 있습니다. 정보를 새로 고친 뒤 다시 시도하세요.' },
        backup: { title: '백업·복구', officialPublish: '공식 계정 백업 만들기', officialRestore: '공식 계정 백업 복원', officialCancel: '백업 업로드 취소', officialRestoreConfirm: '공식 계정 백업으로 이 기기의 데이터를 교체할까요?', officialRestoreInlayWarning: '공식 스냅샷에는 별도로 저장된 채팅 첨부가 포함되지 않습니다. 연결된 이미지, 오디오, 동영상, 서명은 복원되지 않을 수 있습니다. 백업을 복원한 뒤 앱이 다시 시작됩니다. 계속할까요?', officialMissing: '공식 계정 백업을 찾지 못했습니다. 이 기기의 데이터는 변경되지 않았습니다.', officialPublishConfirm: '현재 이 기기의 데이터로 공식 계정 백업을 덮어쓸까요?', officialPublished: '공식 계정 백업을 만들었습니다.', actionFailed: '백업 작업을 완료하지 못했습니다. 일부 변경이 이미 적용되었을 수 있습니다.', progressPreparing: '준비 중', progressTransferring: '데이터 전송 중', progressFinalizing: '마무리 중' },
        platform: { title: '플랫폼', notifications: '알림', notificationsOn: '허용됨', notificationsOff: '꺼짐', openSettings: '시스템 설정 열기', keepAlive: '응답 생성 중 앱 유지', keepAliveHelp: 'AI 응답을 받는 동안 알림을 표시해 앱이 백그라운드에서 종료되지 않게 합니다.', keepAliveNeedsNotifications: '알림이 꺼져 있으면 이 기능이 동작하지 않습니다.', operatingSystem: '운영체제', webView: 'WebView', transferMode: '전송 방식' },
        ...
        sync: { menuTitle: '기기 동기화', intro: '다른 기기와 데이터를 복사하거나 동기화합니다.', registrationExpired: '등록이 만료되었습니다. 새 등록 링크로 다시 등록하세요.', share: { title: '공유', stateOff: '꺼짐', statePreparing: '준비 중', stateListening: '대기 중', stateStopping: '정리 중', stateError: '오류', errorPortUnavailable: '이 포트는 이미 사용 중입니다. 다른 포트를 선택하세요.', errorInvalidConfiguration: '공유 방법, 포트, 공개 주소를 확인하세요.', errorCleanupFailed: '공유는 중지되었지만 정리를 끝내지 못했습니다. 다시 중지해 보세요.', methodLan: '같은 네트워크(LAN)', methodQuick: '임시 인터넷 주소', methodFixed: '고정 주소(고급)', port: '포트', publicUrl: '공개 주소(URL)', quickNote: '앱을 껐다 켜면 주소가 바뀝니다. 그때는 기기를 다시 등록해야 합니다.', fixedNote: '아래 포트를 직접 터널이나 포트 포워딩으로 공개 주소에 연결하세요. 주소는 저장되며, 등록된 기기는 다시 등록하지 않아도 연결됩니다.', fixedGuideTitle: '직접 연결하는 방법', fixedGuideBody: 'Cloudflare Tunnel을 쓰는 경우: Cloudflare 대시보드에서 터널을 만들고, 이 컴퓨터에 cloudflared를 서비스로 설치한 뒤, 터널 대상 주소를 http://127.0.0.1:{0} 으로 지정하세요. 앱은 터널 토큰을 저장하지 않으며 필요하지도 않습니다.', autoListen: '앱을 켜면 자동으로 대기 시작', start: '공유 시작', stop: '공유 중지', pairTitle: '새 기기 등록', pairNote: '등록 링크는 10분 동안 한 기기에만 쓸 수 있습니다.', pairRemaining: '{0} 남음', durationMinute: '{0}분', durationMinutes: '{0}분', durationSecond: '{0}초', durationSeconds: '{0}초', pairExpired: '만료됨. 새 링크를 만드세요.', copyLink: '링크 복사', newLink: '새 링크 만들기', permRead: '데이터 가져가기 허용', permBidirectional: '양방향 동기화 허용', permBidirectionalHelp: '허용하면 상대 기기가 이 기기의 데이터를 바꿀 수도 있습니다.' }, devices: { title: '등록된 기기', note: '한 번 등록한 기기는 다시 등록하지 않아도 연결됩니다.', outgoingTitle: '이 기기에서 가져가는 기기', incomingTitle: '이 기기가 받아오는 기기', permRead: '가져가기', permBidirectional: '양방향', outgoingEmpty: '아직 없습니다. 공유를 켜고 다른 기기에서 등록 링크를 열면 여기에 표시됩니다.', incomingEmpty: '아직 없습니다. 다른 기기의 등록 링크를 아래 동기화 작업에서 사용하면 여기에 저장됩니다.', lastSeen: '마지막 연결 {0} · 누적 {1}', revoke: '해제', revokeConfirm: '이 기기를 해제할까요? 해제한 기기는 다시 등록하기 전까지 연결할 수 없습니다.' }, work: { title: '동기화 작업', target: '대상 기기', useNewLink: '새 등록 링크 사용...', linkPlaceholder: '등록 링크 붙여넣기', clone: '전체 복사 받기', cloneConfirm: '상대 기기의 데이터로 이 기기의 데이터를 통째로 교체합니다. 교체 전에 현재 데이터를 백업으로 보관합니다. 계속할까요?', delta: '바뀐 내용만 받기', bidirectional: '양방향 동기화', blockedWhileSharing: '공유를 끄면 받기 작업을 할 수 있습니다.', registerBlockedByActiveWork: '진행 중인 작업을 끝내거나 중단한 뒤 새 기기를 등록하세요.', sourceInUse: '이 기기를 쓰는 작업이 진행 중입니다. 작업을 끝내거나 취소한 뒤 다시 시도하세요.', sourceChanged: '이 기기의 등록 정보가 바뀌었습니다. 대상 기기를 다시 선택해 다시 시도하세요.', deltaBlockedByRetained: '끝나지 않은 이전 증분 업데이트가 남아 있어 진행할 수 없습니다. 동기화 작업에서 이어서 진행하거나 취소하세요.', deltaRetained: '이전 증분 업데이트가 끝나지 않은 채 남아 있습니다. 상대 기기: {0}', deltaRetainedResumable: '상대 기기를 다시 켜고 이어서 진행하면 마무리됩니다. 상대 기기를 더 쓸 수 없으면 취소하세요.', deltaRetainedAmbiguous: '그 뒤 이 기기의 데이터가 바뀌어 이어서 진행할 수 없습니다. 취소하면 받기, 해제, 등록을 다시 할 수 있습니다.', deltaAbandonConfirm: '남아 있는 증분 업데이트를 취소할까요? 이 기기의 데이터는 그대로 유지되지만 상대 기기의 전송 통계는 갱신되지 않을 수 있습니다.', unknownDevice: '알 수 없는 기기', peerOutdated: '상대 기기의 RisuNest 버전이 오래되었습니다. 두 기기를 같은 버전으로 업데이트한 뒤 다시 시도하세요.', progress: '받는 중 {0}%', cancel: '취소', conflictTitle: '충돌이 있습니다', conflictBody: '같은 항목이 두 기기에서 다르게 바뀌었습니다. 어느 쪽을 유지할지 선택하세요. 선택하지 않은 쪽도 백업으로 보관됩니다.', conflictOthers: '기타 항목 {0}개', keepThis: '이 기기 유지', keepOther: '상대 기기 유지', resume: '이어서 진행', abandon: '작업 취소', abandonConfirm: '진행 중인 동기화를 취소할까요? 지금까지 받은 내용은 적용되지 않습니다.', doneUpToDate: '이미 최신 상태입니다.', doneUpdated: '{0}개 항목을 받았습니다 ({1}).', needClone: '전체 복사가 필요합니다. 위의 전체 복사 받기를 사용하세요.', backupNote: '작업 전 데이터는 백업으로 보관됩니다.', dismiss: '닫기' }, lanWarning: '같은 네트워크(LAN) 연결은 암호화되지 않습니다. 신뢰하는 네트워크에서만 사용하세요.', androidLanOnly: 'Android에서는 같은 네트워크(LAN) 연결만 지원합니다.' },
    },
    peerClone: {
        title: "기기 복제",
        description: "신뢰하는 같은 네트워크의 기기 사이에서 이 RisuNest 라이브러리를 직접 복사합니다. LAN 전송은 일반 HTTP를 사용하므로 연결 코드는 네트워크 도청을 막지 못합니다.",
        unavailable: "이 빌드는 필요한 네이티브 전송과 원자적 활성화를 제공하지 않아 기기 복제를 사용할 수 없습니다.",
        source: "이 기기에서 공유",
        sourceHelp: "시작을 누를 때만 공유가 시작됩니다. 중지하면 서버가 닫히고 모든 기기가 해제되며, 다시 시작하려면 새 페어링이 필요합니다.",
        prepare: "복제 준비",
        start: "공유 시작",
        stop: "공유 중지",
        revoke: "해제",
        target: "다른 기기에서 이 기기 교체",
        targetHelp: "링크를 붙여 넣거나 QR 코드에서 같은 링크를 여세요. 확인 전에는 기존 로컬 데이터가 교체되지 않습니다.",
        pairingLink: "페어링 링크",
        useLink: "링크 사용",
        download: "다운로드 및 교체",
        resume: "재개",
        cancel: "취소",
        progress: "진행률",
        invalidLink: "페어링 링크가 잘못되었습니다.",
        replacementConfirm: "다운로드 후 검증된 복제로 모든 로컬 데이터를 교체할까요? 다운로드나 검증에 실패해도 현재 데이터는 유지됩니다.",
    ...
    peerDelta: {
        ...
        unavailable: "이 데스크톱 빌드에서는 증분 업데이트를 사용할 수 없습니다.",
        source: "이 기기의 업데이트 공유",
        sourceHelp: "고정된 스냅샷을 준비한 다음 인증된 LAN 세션을 시작합니다.",
        sourceOpenHelp: "받는 기기의 작업이 끝날 때까지 이 소스 기기에서 RisuNest를 열어 두고 공유를 유지하세요.",
        sourceStatus: "소스 상태",
        statusIdle: "대기",
        statusPrepared: "준비됨",
        statusRunning: "공유 중",
        ...
        start: "공유 시작",
        stop: "공유 중지",
        pairingLink: "증분 업데이트 링크",
        copyLink: "링크 복사",
        devices: "연결된 기기",
        revoke: "해제",
        target: "이 기기로 업데이트 가져오기",
        targetHelp: "정확히 같은 공통 기반을 이미 공유하는 라이브러리의 증분 업데이트 링크를 붙여 넣으세요.",
        divergenceHelp: "증분 업데이트는 서로 달라진 라이브러리를 교체하지 않습니다. 서로 다른 기기를 처음 연결할 때는 위의 전체 복제를 한 번 실행해야 합니다.",
        pull: "업데이트 가져오기",
        pulling: "업데이트를 가져와 검증하는 중...",
        noChanges: "이 기기는 이미 최신 상태입니다.",
        updated: (objects: number, bytes: string) => `객체 ${objects}개(${bytes}바이트)를 업데이트했습니다.`,
    ...
    peerBidirectional: {
        title: "기기 간 양방향 동기화",
        description: "정확히 공유된 세대를 기준으로 페어링된 데스크톱 기기 사이의 논리 변경 사항을 교환합니다.",
        ...
        start: "페어링 시작",
        stop: "페어링 중지",
        pairingLink: "양방향 동기화 링크",
        copyLink: "링크 복사",
        devices: "페어링된 기기",
        revoke: "해제",
        target: "다른 기기와 동기화",
        targetHelp: "다른 데스크톱 기기의 양방향 동기화 링크를 붙여 넣으세요.",
        sync: "두 기기 동기화",
        ...
        keepRemote: "다른 기기 버전 유지",
        backupWarning: "교체 전에 손실되는 버전을 검증된 무손실 백업으로 저장합니다.",
        backupCreated: "검증된 무손실 백업 생성됨",
        backupLocal: "이 기기에서 만든 백업",
        backupRemote: "다른 기기에서 만든 백업",
        resume: "동기화 재개",
        resumeRequired: "로컬 변경 사항이 반영되었습니다. 다른 기기 반영과 확인을 끝내려면 재개하세요.",
        sourceUnavailable: "다른 기기를 사용할 수 없습니다. 터널 세션이면 그 기기의 새 링크를 붙여 넣으세요. LAN 세션은 기존 호스트가 돌아오면 재개할 수 있습니다.",
