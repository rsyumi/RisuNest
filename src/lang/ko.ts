export const languageKorean = {
    ...
    "help": {
        ...
        "hypaV3EnableSimilarityCorrection": "활성화하면 유사도 검색 시 최근 채팅의 원문과 요약본을 모두 쿼리로 사용하여 검색된 요약의 관련성을 향상시킵니다. 최소 2개 이상의 최근 채팅이 필요합니다.",
        "hypaV3UseExperimentalImpl": "실험적 HypaV3 구현으로 전환합니다. 표준 구현은 dot product 유사도(정규화된 벡터 가정)를 사용하고, 실험적 구현은 cosine similarity(비정규화 벡터 대응)를 사용합니다.",
        "hypaV3AlwaysToggleOn": "활성화하면 캐릭터를 선택할 때마다 HypaV3가 자동으로 활성화됩니다. 각 캐릭터마다 수동으로 토글할 필요가 없습니다.",
        "hypaV3SummarizationRequestsPerMinute": "분당 최대 요약 API 요청 수입니다. 보조 모델을 요약에 사용할 때만 적용됩니다.",
        "hypaV3SummarizationMaxConcurrent": "최대 동시 요약 요청 수입니다. 보조 모델을 요약에 사용할 때만 적용됩니다.",
        "hypaV3EmbeddingRequestsPerMinute": "분당 최대 임베딩 API 요청 수입니다. 유사도 검색에 사용되는 API 기반 임베딩 모델에 적용됩니다.",
        "hypaV3EmbeddingMaxConcurrent": "최대 동시 임베딩 요청 수입니다. 유사도 검색에 사용되는 API 기반 임베딩 모델에 적용됩니다."
    },
    "setup": {
