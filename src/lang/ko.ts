export const languageKorean = {
    ...
    risuNest: {
        ...
        serverSync: {
            ...
            noBackups: '완료된 충돌 백업이 없습니다.',
            restoreLocalBackup: '이 기기 백업 복원',
            restoreRemoteBackup: '서버 백업 복원',
            reregister: '새 기기로 등록',
            reregisterHelp:
                '서버에서 이전 기기를 해지한 다음, 이 라이브러리에 새로 발급한 인증 정보를 입력하세요. 로컬 편집은 보존하고 차이를 비교한 후 동기화합니다.',
            reconcile: '복원된 서버와 비교',
            reconcileHelp:
                '서버가 다른 이력으로 복원되었습니다. 로컬 상태를 백업하고 양쪽 내용을 비교한 후 진행합니다.',
            activationHelp:
                '편집하기 전에 저장 결과를 확인해야 합니다. 화면 새로고침을 눌러 다시 확인하세요.',
            title: '개인 동기화 서버',
            description:
            ...
            progress: {
                ...
                applying: '검증된 변경 적용 중',
                refreshing: '로컬 데이터 갱신 중',
                publishing: '변경 업로드 및 완료 확인 중',
            },
            paused: '일시 중지됨',
            pending: '동기화 완료 확인 중',
            registrationRequired: '새 기기 인증 정보 필요',
            refreshPending: '화면 새로고침 필요',
            initialScan: '최초 전체 비교 준비 중',
            queued: '동기화 대기 항목 {0}개',
            pendingHelp:
                '진행 중인 작업의 결과를 확인한 후 연결을 해제할 수 있습니다. 동기화를 재개하세요.',
            conflict: '충돌 확인 필요',
