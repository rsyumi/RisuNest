export const languageKorean = {
    ...
    risuNest: {
        streaming: {
            outputMode: '스트리밍 출력 후처리',
            outputModeHelp:
                '정확 호환은 제공자의 모든 업데이트에 출력 처리를 적용합니다. 균형은 첫 업데이트 이후 약 0.125초마다 최신 업데이트만 처리합니다. 강함은 스트리밍 중 출력 후처리를 미루고 정상 완료 시 한 번 적용합니다. 선택한 모드는 현재 생성이 끝날 때까지 고정됩니다. 균형과 강함은 상태를 변경하는 정규식·Lua·플러그인의 실행 횟수를 바꿀 수 있습니다. 표시 후처리를 생략하려면 위의 표시 후처리 지연도 켜세요.',
            title: '스트리밍',
            ...
            deferEffectsHelp:
                '켜면 스트리밍 중 해당 응답의 표시 정규식·Lua·플러그인·CBS·번역·서식을 미루고 가벼운 텍스트로 표시합니다. 추론 표시 선택과 독립적으로 동작합니다. 종료 후 전체 원문에 기존 표시 처리를 적용하므로 추론 삭제 규칙도 적용됩니다. 상태를 변경하는 표시 훅의 실행 횟수는 줄어듭니다. 출력 후처리와 저장 내용은 아래 스트리밍 출력 후처리 설정을 따릅니다.',
        },
        startup: {
            storage: '저장소 여는 중',
            data: '대화 데이터 준비 중',
        ...
        platform: { title: '플랫폼', notifications: '알림', notificationsOn: '허용됨', notificationsOff: '꺼짐', openSettings: '알림 설정 열기', keepAlive: '응답 생성 중 앱 유지', keepAliveHelp: 'AI 응답을 받는 동안 알림을 표시해 앱이 백그라운드에서 종료되지 않게 합니다.', keepAliveNeedsNotifications: '알림이 꺼져 있으면 이 기능이 동작하지 않습니다.', operatingSystem: '운영체제', webView: 'WebView', transferMode: '전송 방식' },
        ...
        diag: { title: '진단', viewLog: '오류 로그 보기', copyLog: '오류 로그 복사', fileLog: '오류 로그를 파일로 저장', fileLogHelp: '문제를 신고할 때 이 파일을 함께 보내면 도움이 됩니다. API 키 같은 비밀 정보는 가려서 기록합니다.', logEmpty: '기록된 오류가 없습니다.', actionFailed: '지금은 진단 기능을 사용할 수 없습니다. 앱을 다시 시작한 뒤 다시 시도하세요.' },
        sync: { menuTitle: '기기 동기화', intro: '다른 기기와 데이터를 복사하거나 동기화합니다.', registrationExpired: '등록이 만료되었습니다. 새 등록 링크로 다시 등록하세요.', errorGeneric: '작업을 끝내지 못했습니다. 다시 시도하고, 계속 실패하면 두 기기의 앱을 다시 시작하세요.', errorTransportUnavailable: '상대 기기에 연결할 수 없습니다. 상대 기기가 켜져 있고 공유가 실행 중인지, 두 기기가 같은 네트워크에 있는지 확인하세요.', share: { title: '공유', stateOff: '꺼짐', statePreparing: '준비 중', stateListening: '대기 중', stateStopping: '정리 중', stateError: '오류', errorPortUnavailable: '이 포트는 이미 사용 중입니다. 다른 포트를 선택하세요.', errorInvalidConfiguration: '공유 방법, 포트, 공개 주소를 확인하세요.', errorCleanupFailed: '공유는 중지되었지만 정리를 끝내지 못했습니다. 다시 중지해 보세요.', methodLan: '같은 네트워크(LAN)', methodQuick: '임시 인터넷 주소', methodFixed: '고정 주소(고급)', port: '포트', publicUrl: '공개 주소(URL)', quickNote: '임시 주소를 등록하여 동기화에 사용합니다. 앱을 재시작하면 주소가 변경되므로, 기기를 다시 등록해야 합니다.', fixedNote: '아래 포트를 직접 터널이나 포트 포워딩으로 공개 주소에 연결하세요. 주소는 저장되며, 등록된 기기는 다시 등록하지 않아도 연결됩니다.', fixedGuideTitle: '직접 연결하는 방법', fixedGuideBody: 'Cloudflare Tunnel을 쓰는 경우: Cloudflare 대시보드에서 터널을 만들고, 이 컴퓨터에 cloudflared를 서비스로 설치한 뒤, 터널 대상 주소를 http://127.0.0.1:{0} 으로 지정하세요.', autoListen: '앱을 켜면 자동으로 대기 시작', start: '공유 시작', stop: '공유 중지', pairTitle: '새 기기 등록', pairNote: '등록 링크는 10분 동안 한 기기에만 쓸 수 있습니다.', pairRemaining: '{0} 남음', durationMinute: '{0}분', durationMinutes: '{0}분', durationSecond: '{0}초', durationSeconds: '{0}초', pairExpired: '만료됨. 새 링크를 만드세요.', copyLink: '링크 복사', newLink: '새 링크 만들기', permRead: '데이터 가져가기 허용', permBidirectional: '양방향 동기화 허용', permBidirectionalHelp: '허용하면 상대 기기가 이 기기의 데이터를 바꿀 수도 있습니다.' }, devices: { title: '등록된 기기', note: '한 번 등록한 기기는 다시 등록하지 않아도 연결됩니다.', outgoingTitle: '이 기기에서 가져가는 기기', incomingTitle: '이 기기가 받아오는 기기', permRead: '가져가기', permBidirectional: '양방향', outgoingEmpty: '아직 없습니다. 공유를 켜고 다른 기기에서 등록 링크를 열면 여기에 표시됩니다.', incomingEmpty: '아직 없습니다. 다른 기기의 등록 링크를 아래 동기화 작업에서 사용하면 여기에 저장됩니다.', lastSeen: '마지막 연결 {0} · 누적 {1}', revoke: '해제', revokeConfirm: '이 기기를 해제할까요? 해제한 기기는 다시 등록하기 전까지 연결할 수 없습니다.' }, work: { title: '동기화 작업', target: '대상 기기', useNewLink: '새 등록 링크 사용...', linkPlaceholder: '등록 링크 붙여넣기', linkInvalid: '등록 링크 형식이 아닙니다. 상대 기기의 링크를 처음부터 끝까지 복사하거나 QR 코드를 여세요.', receiving: '받는 중...', conflictSelectTarget: '먼저 위의 대상 기기에서 상대 기기를 선택한 뒤 어느 쪽을 유지할지 고르세요.', clone: '전체 복사 받기', cloneConfirm: '상대 기기의 데이터로 이 기기의 데이터를 통째로 교체합니다. 교체 전에 현재 데이터를 백업으로 보관합니다. 계속할까요?', delta: '바뀐 내용만 받기', bidirectional: '양방향 동기화', blockedWhileSharing: '공유를 끄면 받기 작업을 할 수 있습니다.', registerBlockedByActiveWork: '진행 중인 작업을 끝내거나 중단한 뒤 새 기기를 등록하세요.', sourceInUse: '이 기기를 쓰는 작업이 진행 중입니다. 작업을 끝내거나 취소한 뒤 다시 시도하세요.', sourceChanged: '대상 기기의 등록 정보가 바뀌었습니다. 대상 기기를 다시 선택한 뒤 다시 시도하세요.', deltaBlockedByRetained: '끝나지 않은 이전 증분 업데이트가 남아 있어 진행할 수 없습니다. 동기화 작업에서 이어서 진행하거나 취소하세요.', deltaRetained: '이전 증분 업데이트가 끝나지 않은 채 남아 있습니다. 상대 기기: {0}', deltaRetainedResumable: '상대 기기를 다시 켜고 이어서 진행하면 마무리됩니다. 상대 기기를 더 쓸 수 없으면 취소하세요.', deltaRetainedAmbiguous: '그 뒤 이 기기의 데이터가 바뀌어 이어서 진행할 수 없습니다. 취소하면 받기, 해제, 등록을 다시 할 수 있습니다.', deltaAbandonConfirm: '남아 있는 증분 업데이트를 취소할까요? 이 기기의 데이터는 그대로 유지되지만 상대 기기의 전송 통계는 갱신되지 않을 수 있습니다.', unknownDevice: '알 수 없는 기기', peerOutdated: '상대 기기의 RisuNest 버전이 오래되었습니다. 두 기기를 같은 버전으로 업데이트한 뒤 다시 시도하세요.', progress: '받는 중 {0}%', cancel: '취소', conflictTitle: '충돌이 있습니다', conflictBody: '같은 항목이 두 기기에서 다르게 바뀌었습니다. 어느 쪽을 유지할지 선택하세요. 선택하지 않은 쪽도 백업으로 보관됩니다.', conflictOthers: '기타 항목 {0}개', keepThis: '이 기기 유지', keepOther: '상대 기기 유지', resume: '이어서 진행', abandon: '작업 취소', abandonConfirm: '진행 중인 동기화를 취소할까요? 지금까지 받은 내용은 적용되지 않습니다.', doneUpToDate: '이미 최신 상태입니다.', doneUpdated: '{0}개 항목을 받았습니다 ({1}).', needClone: '전체 복사가 필요합니다. 위의 전체 복사 받기를 사용하세요.', backupNote: '작업 전 데이터는 백업으로 보관됩니다.', dismiss: '닫기', progressLabel: '진행률', deltaConflictBothChanged: '같은 항목이 두 기기에서 모두 바뀌어 받을 수 없습니다. 데이터는 바뀌지 않았습니다. 양방향 동기화를 사용하세요.', deltaConflictLocalChanged: '업데이트 시작 중 로컬 데이터가 변경되었습니다. 데이터는 변경되지 않았습니다. 다시 시도하세요.', bidirectionalSyncing: '변경 사항을 교환하고 검증하는 중...', bidirectionalResumeRequired: '로컬 변경 사항이 반영되었습니다. 다른 기기 반영과 확인을 끝내려면 재개하세요.', bidirectionalSourceUnavailable: '상대 기기에 연결할 수 없습니다. 상대 기기의 공유가 켜져 있는지 확인한 뒤 이어서 진행하세요. 임시 인터넷 주소를 쓰는 기기가 앱을 다시 켰다면 다시 등록해야 합니다.', bidirectionalRefreshPending: '두 기기 반영은 끝났지만 로컬 화면을 새로 고치지 못했습니다.', bidirectionalEditsDiscarded: '상대 기기의 변경을 반영하면서 저장되지 않은 최근 편집이 사라졌습니다. 화면이 방금 전과 다를 수 있습니다.' }, androidLanOnly: 'Android에서는 같은 네트워크(LAN) 연결만 지원합니다.', notificationsDisabledWarning: '이 앱의 알림이 꺼져 있어 전송 중 중지 버튼이 있는 알림이 표시되지 않습니다. 이 화면에서 공유를 중지할 수 있으며, 시스템 설정에서 알림을 허용하면 알림의 중지 버튼을 다시 사용할 수 있습니다.' },
    },
    localToggles: "로컬 토글",
