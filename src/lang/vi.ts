export const languageVietnamese = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "This can be a CORS error. this only happens when using web version dude to limitations of the browser. try using desktop local version, or other version of RisuNest.",
    ...
    "help": {
        ...
        "streamingDisplayOptimizationMode": "Giảm giật lag khi stream phản hồi dài trong các trường hợp có nhiều hậu xử lý, chẳng hạn script dùng regex. Tùy chọn này có thể hữu ích trên thiết bị di động hoặc máy cấu hình thấp.\n\nTương thích chính xác xử lý mọi bản cập nhật từ nhà cung cấp. Chế độ này có độ tương thích cao nhất và chi phí CPU cao nhất.\n\nCân bằng hiển thị ngay bản cập nhật đầu tiên, sau đó chỉ xử lý bản mới nhất khoảng mỗi 0,125 giây. Script có trạng thái có thể chạy ít lần hơn.\n\nMạnh hiển thị bản xem trước thô theo lô và chỉ hậu xử lý ngữ nghĩa một lần khi hoàn tất bình thường. Chế độ này thay đổi hành vi trung gian nhiều nhất.\n\nChế độ đã chọn được cố định cho đến khi lượt tạo hiện tại kết thúc. Cân bằng hoặc Mạnh có thể thay đổi số lần chạy của tác vụ regex, Lua hoặc plugin có trạng thái.",
        ...
        "antiClaudeOverload": "Nếu xảy ra quá tải Claude, RisuNest sẽ cố gắng ngăn chặn bằng cách tiếp tục với cùng một lời nhắc, giúp giảm khả năng xảy ra lỗi. Chỉ hoạt động với các phản hồi được truyền trực tuyến. Điều này có thể không hoạt động đối với các điểm cuối api không chính thức.",
        ...
        "defaultVariables": "Tại đây bạn có thể xác định các biến mặc định của riêng mình. Sử dụng định dạng `<tên biến>=<giá trị biến>`, phân tách bằng dòng mới. Ví dụ, `name=RisuNest`, sau đó có thể được sử dụng với các tập lệnh kích hoạt và biến CBS như `{{getvar::A}}`, `{{setvar::A::B}}` hoặc `{{? $A + 1}}`. Nếu biến mặc định của mẫu lời nhắc và biến mặc định của nhân vật có cùng tên, biến mặc định của nhân vật sẽ được sử dụng.",
    ...
    "setup": {
        ...
        "welcome": "Chào mừng đến với RisuNest! Tôi là Airisu, tôi ở đây để hướng dẫn bạn cài đặt RisuNest. Trước tiên, tôi có thể gọi bạn là gì?",
    ...
    "streamingDisplayOptimizationOff": "Tương thích chính xác",
    "streamingDisplayOptimizationBalanced": "Cân bằng (Khuyên dùng)",
    ...
    "officialWikiDesc": "Wiki chính thức của RisuNest. cứ thoải mái xem nhé.",
    "officialDiscord": "Bất hòa chính thức",
    "officialDiscordDesc": "Discord chính thức nói về RisuNest",
    "persona": "nhân cách",
    "icon": "Biểu tượng",
    "account": "Tài khoản",
    "remove": "Di dời",
    ...
    "restoreLocalSnapshot": "Khôi phục ảnh chụp cục bộ",
    "chooseLocalSnapshot": "Chọn ảnh chụp cục bộ",
    "noLocalSnapshots": "Không có ảnh chụp cục bộ nào.",
    ...
    "realmDesc": "RisuRealm là nền tảng chia sẻ nội dung cho RisuNest. Bạn có thể chia sẻ nhân vật của mình cho người dùng khác.",
    ...
    "risupresetDesc": "Định dạng Risupreset là định dạng được thiết kế dành riêng cho các cài đặt trước RisuNest.",
    "risuMDesc": "Định dạng RisuM là định dạng được thiết kế dành riêng cho các mô-đun RisuNest.",
    ...
    "pluginVersionWarn": "Đây là phiên bản {{plugin_version}} của plugin, không tương thích với phiên bản RisuNest này. Vui lòng cập nhật plugin lên phiên bản {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "RisuNest phát hiện mã có thể gây hại, có thể ĂN CẮP KHÓA API HOẶC DỮ LIỆU CÁ NHÂN CỦA BẠN. Chúng tôi khuyên bạn KHÔNG NÊN CÀI ĐẶT PLUGIN NÀY.",
    "doNotInstall": "Không cài đặt",
    "continueAnyway": "Vẫn tiếp tục",
    "pluginNoRiskButAlert": "RisuNest không phát hiện mã độc hại, nhưng xin lưu ý rằng việc cài đặt plugin từ các nguồn không tin cậy có thể gây rủi ro bảo mật.",
    ...
    screenshotTurns: "Tổng số lượt: {total}",
    screenshotInclusiveRange: "Phạm vi lượt (bắt đầu từ 1, gồm cả hai đầu)",
    screenshotStart: "Bắt đầu",
    screenshotEnd: "Kết thúc",
    screenshotRecent50: "50 lượt gần đây",
    screenshotFull: "Toàn bộ",
    screenshotCapture: "Chụp",
    screenshotProgress: "{completed} trên {total} lượt",
    screenshotEmpty: "Không có lượt nào để chụp.",
    screenshotIntegerRange: "Hãy nhập số lượt nguyên.",
    screenshotRangeBounds: "Số lượt phải nằm trong cuộc trò chuyện.",
