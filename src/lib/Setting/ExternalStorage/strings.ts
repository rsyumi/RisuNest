...
const english = {
    ...
    signInLater: 'You sign in during the next step.',
    ...
    pendingVerification: 'The next step reviews what you entered and asks for the passwords or keys. Pressing Review details does not connect to the server.',
...
const korean: typeof english = {
    ...
    signInLater: '로그인은 다음 단계에서 합니다.',
    scope: '백업에 포함', library: '캐릭터·대화와 첨부 파일', deviceSettings: '이 기기의 설정', devicePlugins: '이 기기의 플러그인 데이터',
    prepare: '입력 내용 확인',
    pendingVerification: '다음 단계에서 입력한 내용을 검토하고 비밀번호나 키를 입력하게 됩니다. 입력 내용 확인 버튼을 눌러도 서버에 연결되지 않습니다.',
