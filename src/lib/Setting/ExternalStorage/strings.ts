...
const english = {
    ...
    deviceSettingsHelp: 'Performance and startup settings of this device. Used when restoring to the same device.',
    included: 'Included',
...
const korean: typeof english = {
    ...
    deviceSettingsHelp: '현재 기기의 성능·시작 관련 설정입니다. 같은 기기로 복원할 때 사용됩니다.',
    included: '포함',
